...
<!--BWC Logo-->
    <a href="dashboard.php" style="font-size:30px;padding-left:10px;color:black;text-decoration:none">
...
<!--Dashboard dropdown-->
  ...
  <div class="dropdown-container" style="color:white">
    ...
    <div class="dropdown-container" style="color:white">
      <a href="#"><i class="fa fa-circle" style="font-size:12px;color:#c500ff"></i> Become a Member</a>
          ...
          <table>
            <tr>
              ...
              <td>
                ...
                <i class="fa fa-mail-reply" style="font-size:24px;color:black;background-color:white;"></i>
                </a>
                </p>
              </td>
            </tr>
