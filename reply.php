...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Black Woman Can - Reply</title>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-12 col-sm-12 col-md-10 col-lg-10 col-xl-10 col-xxl-10" style="padding:20px">
          ...
          <div style="background-color:black;padding-bottom:60px;padding-top:40px">
          ...
          <p style="padding-left:60px;font-size:20px;background-color:black;color:white">
